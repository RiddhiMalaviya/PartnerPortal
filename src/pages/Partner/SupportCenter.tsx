      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h4 className="font-semibold mb-2">What is the response time for support?</h4>
              <p className="text-sm text-gray-600 mb-4">
